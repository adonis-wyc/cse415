...
import heyingge_VI as VI
import heyingge_Q_Learn as Q_Learn
...
#      increment_transition_count()
      ...
      update_policy_displays(which="QL")
        ...
        # Do 10 transitions as quickly as possible, using as many episodes
        # as needed.
      train_quietly(10)
      update_policy_displays(which="QL")
    elif param==-100:
        # Do 100 transitions as quickly as possible, using as many episodes
        # as needed.
      train_quietly(100)
      update_policy_displays(which="QL")
    elif param==-1000:
      ...
      return
        ...
        # Do 10000 transitions as quickly as possible, using as many episodes
        # as needed.
      train_quietly(10000)
      update_policy_displays(which="QL")
      return
    elif param==-100000:
        # Do 100000 transitions as quickly as possible, using as many episodes
        # as needed.
      train_quietly(100000)
      update_policy_displays(which="QL")
      return
  if cmd=="Exploration":
      if Vis.EXPL_VAR.get():
