...
def create_TK_Canvas():
  ...
  QLEARN_MENU.add_command(label="Train for 10 transitions", \
                          command=lambda: MDP_command("QLearn", -10))
  QLEARN_MENU.add_command(label="Train for 100 transitions", \
                          command=lambda: MDP_command("QLearn", -100))
  QLEARN_MENU.add_command(label="Train for 1000 transitions",\
                      command=lambda :MDP_command("QLearn",-1000))
  QLEARN_MENU.add_command(label="Train for 10000 transitions", \
                          command=lambda: MDP_command("QLearn", -10000))
  QLEARN_MENU.add_command(label="Train for 100000 transitions", \
                          command=lambda: MDP_command("QLearn", -100000))
